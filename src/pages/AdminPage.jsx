          ...
          <div className="border-r-[1px] border-solid border-black mt-[5px]">
            ...
            <div className="mx-auto w-[650px] h-[300px] border-[1px] border-red-600 rounded-2xl">
              ...
              <ul className="flex  pl-[20px] space-x-3 pt-[10px] mt-2">
                <li className="bg-gray-800 rounded-full px-4 font-semibold text-white">html</li>
                <li className="bg-gray-800 rounded-full px-4 font-semibold text-white">tailwind css</li>
                <li className="bg-gray-800 rounded-full px-4 font-semibold text-white">react</li>
                <li className="bg-gray-800 rounded-full px-4 font-semibold text-white">next.js</li>
                <li className="bg-gray-800 rounded-full px-4 font-semibold text-white">postgresql</li>
              </ul>
